...
public class NumberUtil {
    ...
    public static U32 add(U32 a, U32 b) {
        return new U32(parse(a.sBidInteger().add(b.sBidInteger()), 4));
    }

    public static U64 add(U64 a, U64 b) {
        return new U64(parse(a.sBidInteger().add(b.sBidInteger()), 8));
    }

    public static U32 sub(U32 a, U32 b) {
        return new U32(parse(a.sBidInteger().subtract(b.sBidInteger()), 4));
    }

    public static U64 sub(U64 a, U64 b) {
        return new U64(parse(a.sBidInteger().subtract(b.sBidInteger()), 8));
    }

    public static U32 mul(U32 a, U32 b) {
        return new U32(parse(a.sBidInteger().multiply(b.sBidInteger()), 4));
    }

    public static U64 mul(U64 a, U64 b) {
        return new U64(parse(a.sBidInteger().multiply(b.sBidInteger()), 8));
    }
    ...
    public static U32 divU(U32 a, U32 b) {
        return new U32(parse(a.sBidInteger().divide(b.sBidInteger()), 4));
    }

    public static U64 divU(U64 a, U64 b) {
        return new U64(parse(a.sBidInteger().divide(b.sBidInteger()), 8));
    }
    ...
    public static U32 remU(U32 a, U32 b) {
        return new U32(parse(a.sBidInteger().remainder(b.sBidInteger()), 4));
    }

    public static U64 remU(U64 a, U64 b) {
        return new U64(parse(a.sBidInteger().remainder(b.sBidInteger()), 8));
    }

    public static U32 and(U32 a, U32 b) {
        return new U32(new byte[] {
    ...
    public static U32 shrU(U32 a, U32 b) {
        int length = b.sBidInteger().remainder(BigInteger.valueOf(32)).intValue();
        String v = toBinaryArray(a.getBytes());
        return new U32(zeros(length) +  v.substring(0, v.length() - length), 2);
    }

    public static U64 shrU(U64 a, U64 b) {
        int length = b.sBidInteger().remainder(BigInteger.valueOf(64)).intValue();
        String v = toBinaryArray(a.getBytes());
        return new U64(zeros(length) +  v.substring(0, v.length() - length), 2);
    }

    public static U32 rotl(U32 a, U32 b) {
        int length = b.sBidInteger().remainder(BigInteger.valueOf(32)).intValue();
        String v = toBinaryArray(a.getBytes());
        return new U32(v.substring(length) + v.substring(0, length), 2);
    }

    public static U64 rotl(U64 a, U64 b) {
        int length = b.sBidInteger().remainder(BigInteger.valueOf(64)).intValue();
        String v = toBinaryArray(a.getBytes());
        return new U64(v.substring(length) + v.substring(0, length), 2);
    }
    ...
    public static U32 rotr(U32 a, U32 b) {
        int length = b.sBidInteger().remainder(BigInteger.valueOf(32)).intValue();
        String v = toBinaryArray(a.getBytes());
        return new U32(v.substring(v.length() - length) + v.substring(0, v.length() - length), 2);
    }

    public static U64 rotr(U64 a, U64 b) {
        int length = b.sBidInteger().remainder(BigInteger.valueOf(64)).intValue();
        String v = toBinaryArray(a.getBytes());
        return new U64(v.substring(v.length() - length) + v.substring(0, v.length() - length), 2);
    }
